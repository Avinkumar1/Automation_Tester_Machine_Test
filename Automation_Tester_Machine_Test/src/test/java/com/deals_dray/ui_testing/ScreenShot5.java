...
public class ScreenShot5 
{
	...
	{
		FileInputStream file = new FileInputStream("./src/test/resource/DealsDray5.properties");
		...
		org.openqa.selenium.Dimension definedResolutions = new org.openqa.selenium.Dimension(414,869);
		driver.manage().window().setSize(definedResolutions);
		TakesScreenshot ts = (TakesScreenshot)driver;
		File tempScreenShot = ts.getScreenshotAs(OutputType.FILE);
		File permScreenShot = new File("./Output/" + timeStamp + "GetCalleyFromBrowser414-869.png");
