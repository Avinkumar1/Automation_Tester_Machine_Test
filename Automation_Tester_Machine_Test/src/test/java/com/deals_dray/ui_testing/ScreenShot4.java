...
public class ScreenShot4 
{
	...
	{
		FileInputStream file = new FileInputStream("./src/test/resource/DealsDray4.properties");
		...
		org.openqa.selenium.Dimension definedResolutions = new org.openqa.selenium.Dimension(360,640);
		driver.manage().window().setSize(definedResolutions);
		TakesScreenshot ts = (TakesScreenshot)driver;
		File tempScreenShot = ts.getScreenshotAs(OutputType.FILE);
		File permScreenShot = new File("./Output/" + timeStamp + "GetCalleyFromBrowser360-640.png");
